$(document).ready(function () {
    ...
    paciente2 = new Paciente('Cristopher', 33, '16901202-0', 'Hipertiroidismo');
    ...
    consultorio1 = new Consultorio('Consultorio de Cristopher', [paciente1, paciente2, paciente3, paciente4, paciente5]);

    consultorio1.agregarPaciente(paciente6);

    consultorio1.mostrarPacientes();
    console.log('Los nombres filtrados son:')
    consultorio1.filtrarPorNombre('Cristopher')
});